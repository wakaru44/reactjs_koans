...
class WhatsYourName extends React.Component {
  ...
  onNameChange(event) {
    ...
    // It must provide the name only if non empty
  ...
  render() {
    const defaultMessage = "Hey there. Enter your name.";
    var messageToRender = "";
    if (this.state.name.length === 0) {
      messageToRender = defaultMessage;
    }else{
      messageToRender = "Hello " + this.state.name;
    }
